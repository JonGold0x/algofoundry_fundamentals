...
class PyCompileOp {
    ...
    runPythonScript(filename, scInitParam) {
        ...
        if (scInitParam === undefined) {
            return (0, child_process_1.spawnSync)("python3", [filePath], { encoding: "utf8" });
        }
        return (0, child_process_1.spawnSync)("python3", [filePath, scInitParam], { encoding: "utf8" });
    }
    /**
     ...
     */
    validatePythonModule(module) {
        (0, child_process_1.exec)(`pip list | grep ${module}`, (err) => {
            if (err) {
