...
exports.assertJSON = exports.concatArrays = exports.strHexToBytes = exports.bigEndianBytesToBigInt = exports.bigintToBigEndianBytes = exports.parseBinaryStrToBigInt = exports.getEncoding = exports.convertToBuffer = exports.convertToString = exports.keyToBytes = exports.assertBase32 = exports.assertBase64Url = exports.assertBase64 = exports.assertLen = exports.assertNumber = exports.assertOnlyDigits = void 0;
...
function assertLen(val, expected, line) {
    if (val !== expected) {
        throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.ASSERT_LENGTH, {
            exp: expected,
            got: val,
            line: line,
        });
 ...
 * @param line : line number in TEAL file
 */
function assertBase64Url(str, line) {
    if (!constants_1.reBase64Url.test(str)) {
        throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.INVALID_BASE64URL, { val: str, line: line });
    }
}
exports.assertBase64Url = assertBase64Url;
/**
...
exports.strHexToBytes = strHexToBytes;
/*
 ...
 * @param jsonString
 */
function assertJSON(jsonString, line) {
    const strictBigJSON = (0, json_bigint_1.default)({ strict: true });
    try {
        strictBigJSON.parse(jsonString);
    }
    catch (e) {
        throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.INVALID_JSON_PARSING, {
            line: line,
        });
    }
}
