...
import { TxnRefFields } from "../lib/constants";
import { Context, EncTx, StackElem, TxField } from "../types";
export declare const assetTxnFields: Set<TxnRefFields>;
 ...
 */
export declare function txnSpecByField(txField: string, tx: EncTx, gtxns: EncTx[], interpreter: Interpreter): StackElem;
/**
 ...
 * @param txn Encoded EncTx Object
 */
export declare function isEncTxAssetCreate(txn: EncTx): boolean;
/**
 * Checks if given encoded transaction obj is asset reconfiguration
 * @param txn Encoded EncTx Object
 */
export declare function isEncTxAssetReconfigure(txn: EncTx): boolean;
/**
 * Checks if given encoded transaction obj is asset revoke
 * @param txn Encoded EncTx Object
 */
export declare function isEncTxAssetRevoke(txn: EncTx): boolean;
/**
 * Checks if given encoded transaction obj is asset freeze
 * @param txn Encoded EncTx Object
 */
export declare function isEncTxAssetFreeze(txn: EncTx): boolean;
/**
 * Checks if given encoded transaction obj is asset opt in
 * @param txn Encoded EncTx Object
 */
export declare function isEncTxAssetOptIn(txn: EncTx): boolean;
/**
 * Checks if given encoded transaction obj is asset opt in
 * @param txn Encoded EncTx Object
 */
export declare function isEncTxAssetTransfer(txn: EncTx): boolean;
/**
