 ...
 * @param line : line number in TEAL file
 */
export declare function assertBase64Url(str: string, line: number): void;
/**
 ...
 * @param str
 */
export declare function strHexToBytes(str: string): Uint8Array;
export declare function concatArrays(...arrs: ArrayLike<number>[]): Uint8Array;
/**
 * assert if given string is a valid JSON object
 * @param jsonString
 */
export declare function assertJSON(jsonString: string, line: number): void;
