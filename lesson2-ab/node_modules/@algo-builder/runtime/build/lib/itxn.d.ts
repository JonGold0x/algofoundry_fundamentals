 ...
 */
export declare function setInnerTxField(subTxn: EncTx, field: string, val: StackElem, op: Op, interpreter: Interpreter, line: number): EncTx;
/**
 * Calculate remaining fee after executing an inner transaction;
 * @param interpeter current interpeter contain context
 */
export declare function calculateInnerTxCredit(interpeter: Interpreter): CreditFeeType;
export declare function getInnerTxDefaultFee(interpeter: Interpreter): number;
/**
 ...
 */
export declare function addInnerTransaction(interpreter: Interpreter, line: number): EncTx;
