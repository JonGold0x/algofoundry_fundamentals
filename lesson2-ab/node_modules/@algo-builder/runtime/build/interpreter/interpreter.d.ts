...
import { AccountStoreI, EncTx, ExecutionMode, SSCAttributesM, StackElem, TEALStack } from "../types";
...
export declare class Interpreter {
     ...
     */
    getAccount(accountRef: StackElem, line: number, createFlag?: boolean, immutable?: boolean): AccountStoreI;
    /**
     ...
     */
    private _getAccountFromReference;
    /**
     ...
     *       the result is zero.
     */
    executeWithResult(program: string, runtime: Runtime, debugStack?: number): StackElem | undefined;
    /**
