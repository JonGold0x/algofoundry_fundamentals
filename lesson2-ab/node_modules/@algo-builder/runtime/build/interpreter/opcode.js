...
class Op {
    ...
    assert64BitIndex(index, line) {
        if (index > constants_1.MAX_UINT6) {
            throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.SET_BIT_INDEX_ERROR, {
                index: index,
                line: line,
            });
        }
    ...
    assertBytesIndex(index, array, line) {
        if (index >= array.length) {
            throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.SET_BIT_INDEX_BYTES_ERROR, {
                index: index,
                line: line,
            });
        }
    ...
    assertTxFieldDefined(str, tealVersion, line) {
        if (constants_1.TxnFields[tealVersion][str] === undefined) {
            throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.UNKNOWN_TRANSACTION_FIELD, {
                field: str,
                version: tealVersion,
                line: line,
            });
    ...
    assertTxArrFieldDefined(str, tealVersion, line) {
        if (!constants_1.TxArrFields[tealVersion].has(str)) {
            throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.INVALID_OP_ARG, {
                opcode: str,
                version: tealVersion,
                line: line,
            });
    ...
    assertITxFieldDefined(str, tealVersion, line) {
        if (constants_1.TxnFields[tealVersion][str] === undefined &&
            constants_1.ITxnFields[tealVersion][str] === undefined) {
            throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.UNKNOWN_TRANSACTION_FIELD, {
                field: str,
                version: tealVersion,
                line: line,
    ...
    assertGlobalDefined(str, tealVersion, line) {
        if (constants_1.GlobalFields[tealVersion][str] === undefined) {
            throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.UNKNOWN_GLOBAL_FIELD, {
                field: str,
                version: tealVersion,
                line: line,
            });
    ...
    opExtractImpl(array, start, length) {
        ...
        if (start > array.length) {
            throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.EXTRACT_RANGE_ERROR, {
                given: start,
                length: array.length,
            });
        }
     ...
     */
    assertInnerTransactionExists(interpreter) {
        if (interpreter.innerTxnGroups.length === 0) {
            throw new runtime_errors_1.RuntimeError(errors_list_1.RUNTIME_ERRORS.TEAL.NO_INNER_TRANSACTION_AVAILABLE, {
     ...
     */
    assertFieldIndex(arg, indexArray) {
        let argument = arg;
        try {
