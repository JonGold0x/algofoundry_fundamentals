...
import { EncodingType, EncTx, StackElem, TEALStack } from "../types";
...
declare abstract class HashOp extends Op {
    readonly line: number;
    readonly interpreter: Interpreter;
    /**
     * Asserts 0 arguments are passed.
...
declare abstract class HashOpSHA3 extends Op {
    readonly line: number;
    /**
     * Asserts 0 arguments are passed.
     * @param args Expected arguments: [] // none
...
export declare class Sha256 extends HashOp {
    computeCost(): number;
    execute(stack: TEALStack): number;
}
export declare class Sha512_256 extends HashOp {
    computeCost(): number;
    execute(stack: TEALStack): number;
}
export declare class Keccak256 extends HashOpSHA3 {
    readonly interpreter: Interpreter;
    /**
     * Asserts 0 arguments are passed.
     * @param args Expected arguments: [] // none
...
export declare class Sha3_256 extends HashOpSHA3 {
    computeCost(): number;
    execute(stack: TEALStack): number;
}
...
export declare class Ed25519verify_bare extends Op {
    readonly line: number;
    /**
     * Asserts 0 arguments are passed.
     * @param args Expected arguments: [] // none
...
export declare class Divw extends Op {
    readonly line: number;
    /**
     * Asserts 0 arguments are passed.
     * @param args Expected arguments: [] // none
...
export declare class Gloadss extends Gload {
    /**
     * Stores scratch space index number according to argument passed.
     * @param args Expected arguments: [index number]
     * @param line line number in TEAL file
...
export declare class ByteGreaterThan extends ByteOp {
    execute(stack: TEALStack): number;
}
...
export declare class Bsqrt extends Op {
    readonly line: number;
    /**
     * Asserts 0 arguments are passed.
     * @param args Expected arguments: [] // none
...
export declare class ITxnas extends ITxna {
    /**
...
export declare class AcctParamsGet extends Op {
    readonly interpreter: Interpreter;
    readonly line: number;
    readonly field: string;
    /**
...
export declare class ITxnNext extends Op {
    readonly interpreter: Interpreter;
    readonly line: number;
    /**
     * Stores index number according to the passed arguments
...
export declare class Gitxn extends Gtxn {
    /**
...
export declare class Gitxna extends Gtxna {
    /**
     * Sets `field`(Transaction Field), `fieldIdx`(Array Index) and
     * `txIdx`(Transaction Group Index) values according to the passed arguments.
     * @param args Expected arguments:
...
export declare class Gitxnas extends Gtxnas {
    /**
     * Sets `field`(Transaction Field), `fieldIdx`(Array Index) and
     * `txIdx`(Transaction Group Index) values according to the passed arguments.
     * @param args Expected arguments:
 ...
 */
export declare class Base64Decode extends Op {
    readonly line: number;
...
export declare class Replace extends Op {
    readonly line: number;
    start: number;
    original: Uint8Array;
    replace: Uint8Array;
 ...
 */
export declare class Replace2 extends Replace {
    /**
     * Asserts 0 arguments are passed.
 ...
 */
export declare class Replace3 extends Replace {
    /**
     * Asserts 0 arguments are passed.
     * @param line line number in TEAL file
     */
 ...
 */
export declare class Json_ref extends Op {
    readonly line: number;
...
export declare class Bn254Add extends Op {
    readonly line: number;
    /**
     * @param args
     * @param line line number in TEAL file
...
export declare class Bn254ScalarMul extends Op {
    readonly line: number;
    /**
     * @param args
     * @param line line number in TEAL file
...
export declare class Bn254Pairing extends Op {
    readonly line: number;
    /**
     * @param args
     * @param line line number in TEAL file
 ...
 */
export declare class Block extends Op {
    readonly line: number;
    readonly field: string;
    readonly interpreter: Interpreter;
    /**
 ...
 * Cost: 5700
 */
export declare class VrfVerify extends Op {
    readonly line: number;
 ...
 * Availability: v8
 */
export declare class Switch extends Op {
    readonly line: number;
