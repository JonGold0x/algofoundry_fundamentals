...
exports.defaultSDKAccounts = exports.BaseModelI = exports.AccountStore = exports.RuntimeAccount = void 0;
...
class AccountStore {
    ...
    addApp(appID, appDefinition) {
        ...
        this.minBalance +=
            constants_1.APPLICATION_BASE_FEE +
                constants_1.SSC_VALUE_UINT * appDefinition.globalInts +
                constants_1.SSC_VALUE_BYTES * appDefinition.globalBytes;
...
class App {
    // NOTE - approval and clear program must be the TEAL code as string
    constructor(creatorAddr, appID, appDefinition) {
        this.id = appID;
