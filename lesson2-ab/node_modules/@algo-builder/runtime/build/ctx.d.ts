...
import algosdk, { modelsv2, Transaction, TransactionType } from "algosdk";
import { Runtime } from ".";
import { AccountAddress, AccountStoreI, AppInfo, ASADeploymentFlags, ASAInfo, AssetHoldingM, Context, EncTx, ID, SCParams, SSCAttributesM, StackElem, State, TxReceipt } from "./types";
export declare class Ctx implements Context {
     ...
     * @param flags ASA Deployment Flags
     */
    deployASADef(name: string, asaDef: types.ASADef, fromAccountAddr: AccountAddress, flags: ASADeploymentFlags): ASAInfo;
    /**
     ...
     */
    deployApp(creatorAddr: AccountAddress, appDefinition: types.AppDefinition, idx: number, scTmplParams?: SCParams): AppInfo;
    /**
     ...
     * @param scTmplParams Smart Contract template parameters
     */
    updateApp(appID: number, appSourceCode: types.SmartContract, idx: number, scTmplParams?: SCParams): TxReceipt;
    /**
     * Rekeys the account
     ...
     */
    processTransactions(signedTransactions: algosdk.SignedTransaction[], appDefMap?: Map<number, types.AppDefinition | types.SmartContract>, lsigMap?: Map<number, types.Lsig>): TxReceipt[];
}
