...
import { AccountAddress, AccountStoreI, AppLocalStateM, AssetHoldingM, CreatedAppM, RuntimeAccountI, SSCAttributesM, StackElem } from "./types";
...
export declare const defaultSDKAccounts: {
    alice: {
        addr: string;
        sk: Uint8Array;
    };
