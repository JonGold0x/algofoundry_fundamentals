...
export declare type TxReceipt = BaseTxReceipt | AppInfo | ASAInfo;
...
export interface Context {
    ...
    deployApp: (fromAccountAddr: string, appDefinition: types.AppDefinition, idx: number, scTmplParams?: SCParams) => AppInfo;
