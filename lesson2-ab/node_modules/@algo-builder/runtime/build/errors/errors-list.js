...
by an index that does not exist.`,
    ...
    PRAGMA_VERSION_ERROR: {
        number: 1017,
        message: "Pragma version Error - Expected version up to: %expected%, got: %got%, Line: %line%",
        title: exports.PARSE_ERROR,
        description: ``,
    },
    INVALID_BASE64: {
    ...
    MAX_LEN_EXCEEDED: {
        number: 1030,
        message: "Length of provided TEAL code = %length% bytes exceeds max length of %maxlen% bytes, Mode: %mode%",
...
maximun uint128`,
    ...
    NO_INNER_TRANSACTION_AVAILABLE: {
        number: 1049,
        message: "No inner transaction available. Teal version: #%tealVersion%, [error-line: %line%]",
    ...
    UNKNOWN_ACCT_FIELD: {
        number: 1056,
        message: "Account Field Error - Unknown Field:  %field% at line %line% for teal version #%tealV%",
        title: "Account Field Error at line %line%",
        description: `Account field unknown`,
    },
    ITXN_NEXT_WITHOUT_ITXN_BEGIN: {
        number: 1057,
        message: "itxn_next without itxn_begin: trying to submit an inner transaction without begin, at line %line%",
    ...
    PROGRAM_LENGTH_EXCEEDED: {
        ...
        description: "Maximum program length %maxAppProgramLen% exceeded. Use `ApprovalProgramPages` instead",
    },
    ...
    EXTRA_PAGES_EXCEEDED: {
        ...
        title: "Extra pages",
        description: "Allowed extra pages range is from 0 to %maxExtraAppProgramPages% but got %extraPages% extra pages",
    },
    UNKNOWN_BLOCK_FIELD: {
        number: 1072,
...
const runtimeGeneralErrors = {
    ...
    MAX_SCHEMA_ENTRIES_EXCEEDED: {
        ...
        description: "Local key entires: used: %localState%, max: %localMax%. Global  key entires: used: %globalState, max: %globalMax%.",
    },
    ...
    INVALID_MULTISIG: {
        ...
        description: "Provided multisignature is invalid and was not able to authenticate the transaction",
    },
    PRODUCE_BLOCK: {
        number: 1322,
