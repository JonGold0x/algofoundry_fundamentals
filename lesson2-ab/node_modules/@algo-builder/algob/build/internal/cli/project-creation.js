...
exports.installDependencies = exports.createConfirmationPrompt = exports.createProject = exports.printSuggestedCommands = exports.printWelcomeMessage = exports.pkgManager = void 0;
...
function copy(directory, location) {
    fs_extra_1.default.copySync(directory, location, {
        ...
        filter: (_src, dest) => {
            ...
            return path_1.default.basename(dest) !== ".gitkeep";
        },
    });
}
function copySampleProject(location, isTSProject, withInfrastucture) {
    ...
    if (withInfrastucture) {
        copy(path_1.default.join(sampleProjDir, "infrastructure"), path_1.default.join(location, "infrastructure"));
    }
    const projectDir = isTSProject
        ? path_1.default.join(sampleProjDir, "ts")
        : path_1.default.join(sampleProjDir, "js");
    // copy JS/TS project files, depending on --typescript flag
    copy(projectDir, location);
}
function printSuggestedCommands(isNpm) {
    let npx = "";
    ...
    console.log(`  ${npx}${constants_1.ALGOB_NAME} deploy`);
    console.log(`  ${npx}${constants_1.ALGOB_NAME} run`);
...
async function createProject(location, isTSProject, withInfrastucture, isNpm) {
...
async function confirmPluginInstallation(isNpm) {
...
function pkgInstallCommand(isNpm, deps, isDev) {
