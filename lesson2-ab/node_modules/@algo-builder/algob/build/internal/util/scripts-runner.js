...
function displayErr(error, relativeScriptPath) {
    ...
    const maybeWrappedError = (0, web_1.parseAlgorandError)(error, {
        scriptPath: relativeScriptPathWithLine,
    });
...
async function runScript(relativeScriptPath, arg, runtimeEnv, deployer) {
    ...
    try {
        await requiredScript.default(runtimeEnv, deployer, arg);
    }
    catch (error) {
