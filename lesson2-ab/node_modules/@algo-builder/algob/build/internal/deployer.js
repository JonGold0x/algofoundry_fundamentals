...
const txn_1 = require("@algo-builder/web/build/lib/txn");
...
class DeployerBasicMode {
     ...
     */
    sendAndWait(rawTxns, waitRounds = web_1.types.WAIT_ROUNDS) {
     ...
     * @returns TxnReceipt which includes confirmed txn response along with txID
     */
    sendTxAndWait(transactions, rounds) {
    ...
    parseABIContractFile(pathToFile) {
        ...
        const genesisHash = web_1.utils.getGenesisHashFromName(this.networkName);
