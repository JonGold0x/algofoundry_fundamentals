...
import { txWriter } from "./tx-log-writer";
export declare function mkDeployer(allowWrite: boolean, deployerCfg: DeployerConfig): Deployer;
export declare class DeployerConfig {
