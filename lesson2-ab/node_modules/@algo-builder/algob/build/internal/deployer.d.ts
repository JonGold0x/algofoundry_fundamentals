...
import type { Account, LogicSigAccount, modelsv2, SignedTransaction, Transaction } from "algosdk";
import * as algosdk from "algosdk";
import { txWriter } from "../internal/tx-log-writer";
import { AlgoOperator } from "../lib/algo-operator";
import type { AppCache, ASCCache, CheckpointFunctions, CheckpointRepo, Deployer, FundASCFlags, LogicSig, LsigInfo, RuntimeEnv, SCParams, TxnReceipt } from "../types";
...
declare class DeployerBasicMode {
     ...
     */
    makeAndSignTx(execParams: wtypes.ExecParams[], txParams: algosdk.SuggestedParams, signer: wtypes.Sign): SignedTransaction[];
    /**
...
export declare class DeployerDeployMode extends DeployerBasicMode implements Deployer {
     ...
     */
    executeTx(transactions: wtypes.ExecParams[] | wtypes.TransactionAndSign[]): Promise<TxnReceipt[]>;
}
/**
