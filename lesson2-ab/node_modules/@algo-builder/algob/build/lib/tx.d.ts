 ...
 */
export declare function executeTx(deployer: Deployer, transactions: wtypes.ExecParams[] | wtypes.TransactionAndSign[]): Promise<TxnReceipt[]>;
/**
 ...
 */
export declare function executeSignedTxnFromFile(deployer: Deployer, fileName: string): Promise<TxnReceipt>;
