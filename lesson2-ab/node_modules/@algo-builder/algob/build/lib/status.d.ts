 ...
 */
export declare function printLocalStateApp(deployer: Deployer, accountAddr: AccountAddress, appID: number): Promise<void>;
/**
 ...
 * @param appID application index of smart contract
 */
export declare function printGlobalStateApp(deployer: Deployer, creatorAddr: AccountAddress, appID: number): Promise<void>;
