...
exports.executeSignedTxnFromFile = exports.executeTx = exports.signTransactions = exports.makeAndSignTx = exports.makeASAOptInTx = exports.makeAssetCreateTxn = exports.isSignedTx = void 0;
    ...
    switch (signer.sign) {
        ...
        case web_1.types.SignType.LogicSignature: {
            if (signer?.lsig?.lsig?.args) {
                ...
                signer.lsig.args = signer.args ?? []; // args property didn't exist in earlier version of API (for reference: see the multisig example)
            }
 ...
 */
async function executeTx(deployer, transactions) {
    let isSDK = false;
    let signedTxn;
    ...
    if (isSDK && signedTxn) {
        ...
        return await deployer.getReceiptTxns(transactions.map((txn) => txn.transaction));
    }
    ...
    try {
        ...
        if (deployer.isDeployMode) {
            await (0, script_checkpoints_1.registerCheckpoints)(deployer, execParams, txns, txIdxMap);
        }
        else {
