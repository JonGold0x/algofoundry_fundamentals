...
class CompileOp {
     ...
     */
    async ensureCompiled(filename, tealSource = "", force, scTmplParams) {
        if (!filename.endsWith(exports.tealExt) &&
            !filename.endsWith(exports.lsigExt) &&
            !filename.endsWith(exports.pyExt)) {
        ...
        if (tealSource === "") {
            ...
            if (filePath === undefined) {
                throw new web_1.BuilderError(runtime_1.ERRORS.GENERAL.FILE_NOT_FOUND_IN_DIR, {
                    directory: project_structure_1.ASSETS_DIR,
                    file: filename,
                });
            }
    ...
    async compile(filename, tealCode, tealHash, scParams) {
        try {
