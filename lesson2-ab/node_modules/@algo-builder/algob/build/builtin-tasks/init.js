...
function default_1() {
    (0, config_env_1.task)(task_names_1.TASK_INIT, "Initializes a new project(JS by default) in the given directory")
        .addPositionalParam("newProjectLocation", "Location of the new project")
        ...
        .setAction(async ({ newProjectLocation, typescript, infrastructure, npm, }, _) => await (0, project_creation_1.createProject)(newProjectLocation, typescript, infrastructure, npm));
}
