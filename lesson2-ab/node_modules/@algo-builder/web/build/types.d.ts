...
export declare type ExecParams = AlgoTransferParam | AssetTransferParam | KeyRegistrationParam | AppCallsParam | ModifyAssetParam | FreezeAssetParam | RevokeAssetParam | DestroyAssetParam | DeployASAParam | DeployAppParam | OptInASAParam | UpdateAppParam;
...
export declare type Lsig = SignWithLsig;
export declare type Sign = SignWithSk | SignWithLsig | SignWithMultisig;
...
export declare type SourceCompiled = {
    metaType: MetaType.BYTES;
    approvalProgramBytes: Uint8Array;
    clearProgramBytes: Uint8Array;
};
export declare type SmartContract = (SourceFile | SourceCode | SourceCompiled) & {
    extraPages?: number;
};
export declare type AppDefinitionFromFile = StorageConfig & AppOptionalFlags & SourceFile;
export declare type AppDefinitionFromSource = StorageConfig & AppOptionalFlags & SourceCode;
export declare type AppDefinitionFromSourceCompiled = StorageConfig & AppOptionalFlags & SourceCompiled;
export declare type AppDefinition = AppDefinitionFromFile | AppDefinitionFromSource | AppDefinitionFromSourceCompiled;
export declare type DeployAppParam = BasicParams & {
...
export declare type KeyRegistrationParam = BasicParams & {
...
export declare function isExecParams(object: unknown): object is ExecParams;
